...
if(!isset($_GET["teamName"]) || empty($_POST["eventName"]) || empty($_POST["daysUntilEvent"]) || empty($_POST["eventDesc"]) ){
...
try{
    ...
    addEvent($teamName, $_POST["eventName"], $_POST["eventDesc"], $currentDate, $dateOf, $creator);
